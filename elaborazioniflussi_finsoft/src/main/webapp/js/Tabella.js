import Paginator from "./js/Paginator.js"
	...
	/**
	 * titolo; service; idTabella; classeTabella; contenitore; page
	 * callbackCreate callbackUpdate callbackDelete
	 */
	...
	export default class Tabella {
		...
		_addCaption(titolo){
			let caption = document.createElemment("caption")
	...
	onRowClick(e) {
		...
		this.rowSelected.classList.toggle('roe-element');
	}
